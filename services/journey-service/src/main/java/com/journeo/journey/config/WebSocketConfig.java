...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    @Override public void registerStompEndpoints(StompEndpointRegistry r){ r.addEndpoint("/ws").setAllowedOriginPatterns("*").withSockJS(); r.addEndpoint("/ws").setAllowedOriginPatterns("*"); }
}
