...
export const CardDevice: React.FC<DeviceProps> = ({ config, theme, onAdvance }) => {
  ...
  return <div className="overflow-hidden">
    ...
    <div className="p-4">
      ...
      {cfg.title && <h3 className="font-semibold text-slate-800 mb-1" style={{ fontFamily: theme.font }}>{cfg.title}</h3>}
      {cfg.description && <p className="text-sm text-slate-600 mb-3" style={{ fontFamily: theme.font }}>{cfg.description}</p>}
