...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background p-6 shadow-overlay transition ease-editorial data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-200',
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn('font-display text-2xl font-normal text-foreground', className)} {...props} />
))
